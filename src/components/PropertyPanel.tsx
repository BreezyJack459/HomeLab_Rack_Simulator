...
function PropertySection({
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white/70 p-3 dark:border-slate-800 dark:bg-slate-950/70">
      <button
        type="button"
...
function renderPortPlacement(device: PlacedDevice, patch: (patchValue: Partial<PlacedDevice>) => void) {
  ...
  return (
    <div className="border-t border-slate-200 pt-3 dark:border-slate-800">
      <div className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-400 dark:text-slate-500">
        Port placement
      </div>
    ...
    <section className="rounded-lg border border-slate-200 bg-slate-100/78 p-4 dark:border-slate-800 dark:bg-slate-900/78">
      ...
      >
        <div className="overflow-hidden">
          {!device ? (
            <div className="space-y-3 rounded-xl border border-dashed border-slate-300 bg-white/60 p-4 text-sm dark:border-slate-700 dark:bg-slate-950/60">
            ...
            <div className="space-y-3">
              <div className="rounded-xl border border-cyan-500/20 bg-cyan-500/10 p-3">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2 text-sm text-slate-700 dark:text-slate-200">
                  ...
                  <span className="rounded-full bg-white/70 px-2 py-0.5 text-[11px] dark:bg-slate-950/60">
                    {device.category}
                  </span>
                  <span className="rounded-full bg-white/70 px-2 py-0.5 text-[11px] dark:bg-slate-950/60">
